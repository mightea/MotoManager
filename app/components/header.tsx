...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full print:hidden">
      <div
        className="absolute inset-0 bg-gradient-to-b from-background/80 via-background/60 to-transparent blur-xl"
        aria-hidden="true"
      />
      <div className="relative mx-auto w-full max-w-6xl md:px-6 md:pt-6">
        <div className="flex items-center justify-between gap-4 rounded-b-2xl md:rounded-2xl border border-border/60 bg-white/80 px-5 py-4 shadow-lg backdrop-blur-xl dark:border-border/30 dark:bg-slate-900/80">
