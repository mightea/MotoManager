...
CREATE TABLE `__new_issues` (
	...
	`updated_at` text DEFAULT '2025-07-07T15:44:55.936Z',
	`created_at` text DEFAULT '2025-07-07T15:44:55.937Z',
	FOREIGN KEY (`motorcycle_id`) REFERENCES `motorcycle`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
INSERT INTO `__new_issues`("id", "motorcycle_id", "odo", "description", "updated_at", "created_at") SELECT "id", "motorcycle_id", "odo", "description", "updated_at", "created_at" FROM `issues`;--> statement-breakpoint
